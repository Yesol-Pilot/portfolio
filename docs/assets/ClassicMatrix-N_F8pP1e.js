import{r as o,m as c,f as l,D as u,n as m,p as f,j as e}from"./index-LI-KpOx_.js";import{H as d}from"./Html-DSAyQE1A.js";const v=({opacity:r=.2})=>{const t=o.useRef(),{viewport:a}=c(),i=o.useMemo(()=>new l({uniforms:{uTime:{value:0},uColor:{value:new m("#00ff41")},uOpacity:{value:r}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
