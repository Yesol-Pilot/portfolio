import{r as c,al as M,am as b,an as A,ao as w,j as e,ap as L,a6 as R,ab as x,a3 as G,Q as N,v as O,l as P,k as U,C as E,x as C,a7 as D,Z as j,X as H}from"./three-D7vjLnNd.js";import{b as k}from"./index-B7JI2npy.js";import"./vendor-CqO7gtIP.js";import"./animation-CETMx-Jf.js";const g={vertexShader:`
    ...
    `},$=({stabilized:a})=>{const o=c.useRef(),{viewport:u}=O(),d=c.useRef(0),s=c.useMemo(()=>new P({uniforms:{uTime:{value:0},uColor:{value:new E("#ef4444")},uSpeed:{value:1}},vertexShader:g.vertexShader,fragmentShader:g.fragmentShader,transparent:!0,depthWrite:!1,side:U}),[]);return C((i,r)=>{if(o.current&&o.current.material&&o.current.material.uniforms){const l=o.current.material.uniforms;a?(d.current===0&&(d.current=i.clock.elapsedTime),l.uTime.value=d.current,l.uSpeed.value=j.lerp(l.uSpeed.value,0,r*2)):(l.uTime.value=i.clock.getElapsedTime(),l.uSpeed.value=1);const n=a?new E("#06b6d4"):new E("#ef4444");l.uColor.value.lerp(n,r*2)}}),e.jsxs("mesh",{ref:o,scale:[u.width,u.height,1],position:[0,0,-5],children:[e.jsx("planeGeometry",{args:[1,1]}),e.jsx("primitive",{object:s,attach:"material"})]})},B=({text:a,position:o,fontSize:u,color:d,intensity:s=1})=>{const i=c.useRef();return C(()=>{i.current&&(Math.random()>1-.05*s?(i.current.position.x=o[0]+(Math.random()-.5)*.1*s,i.current.position.y=o[1]+(Math.random()-.5)*.1*s):i.current.position.set(...o))}),e.jsxs("group",{ref:i,position:o,children:[e.jsx(x,{position:[.02*s,0,0],fontSize:u,color:"cyan",opacity:.5,anchorX:"center",children:a}),e.jsx(x,{position:[-.02*s,0,0],fontSize:u,color:"red",opacity:.5,anchorX:"center",children:a}),e.jsx(x,{position:[0,0,0],fontSize:u,color:d,anchorX:"center",children:a})]})},f=({id:a,position:o,geometry:u,onPatch:d,isPatched:s,speed:i=2})=>{const r=c.useRef(),[l,n]=c.useState(!1),{playHover:p,playClick:v}=k();C((h,m)=>{if(!r.current)return;s?(r.current.rotation.x+=m*.3,r.current.rotation.y+=m*.2,r.current.position.x=j.lerp(r.current.position.x,o[0],m*5),r.current.position.y=j.lerp(r.current.position.y,o[1],m*5)):(r.current.rotation.x+=m*i*(.5+Math.sin(h.clock.elapsedTime*5)*.3),r.current.rotation.y+=m*i*(.5+Math.cos(h.clock.elapsedTime*4)*.3),Math.random()>.9&&(r.current.position.x=o[0]+(Math.random()-.5)*.2,r.current.position.y=o[1]+(Math.random()-.5)*.2));const t=l?1.3:1;r.current.scale.lerp(new H(t,t,t),.1)});const S=()=>{s||(v(),d(a))};return e.jsx(D,{speed:s?2:8,rotationIntensity:s?1:4,floatIntensity:1,children:e.jsxs("mesh",{ref:r,position:o,onPointerOver:()=>{s||(n(!0),p(),document.body.style.cursor="pointer")},onPointerOut:()=>{n(!1),document.body.style.cursor="auto"},onClick:S,children:[e.jsx("primitive",{object:u,attach:"geometry"}),e.jsx("meshBasicMaterial",{color:s?"#06b6d4":l?"#ffffff":"#ef4444",wireframe:!0,transparent:!0,opacity:s?.8:l?.9:.5})]})})},z=()=>{const[a,o]=c.useState(new Set),[u,d]=c.useState(["[SYSTEM] CRITICAL FAILURE IN SECTOR 04","[KERNEL] REALITY INTEGRITY: 12%","[WARNING] DATA CORRUPTION DETECTED"]),s=4,i=12,r=Math.floor((100-i)/s),l=i+a.size*r,n=a.size>=s,p=c.useCallback(t=>{o(y=>{const I=new Set(y);return I.add(t),I});const T={"mod-1":"QUANTUM_CORE","mod-2":"NEURAL_LINK","mod-3":"MEMORY_STACK","mod-4":"REALITY_ANCHOR"};d(y=>[...y,`[PATCHING] ${T[t]||t}...`,`[SUCCESS] Module restored. Integrity +${r}%`])},[r]);c.useEffect(()=>{n&&d(t=>[...t,"[SYSTEM] ALL MODULES RESTORED","[STATUS] SECTOR STABILIZED","",'>>> "Debugging is Creating." <<<'])},[n]);const v=c.useMemo(()=>new M(.8,0),[]),S=c.useMemo(()=>new b(.5,.15,64,12),[]),h=c.useMemo(()=>new A(.7,0),[]),m=c.useMemo(()=>new w(.6,0),[]);return e.jsxs("group",{children:[e.jsx($,{stabilized:n}),e.jsxs("group",{position:[0,0,0],children:[e.jsxs("mesh",{position:[0,0,-1],children:[e.jsx("planeGeometry",{args:[6,4]}),e.jsx("meshBasicMaterial",{color:"#000000",transparent:!0,opacity:.9}),e.jsxs("lineSegments",{children:[e.jsx("edgesGeometry",{args:[new L(6,4)]}),e.jsx("meshBasicMaterial",{color:n?"#06b6d4":"#ef4444"})]})]}),e.jsx(R,{children:e.jsx(B,{text:n?"SECTOR STABILIZED":"THE GLITCH [FATAL ERROR]",position:[0,1.5,0],fontSize:.3,color:n?"#06b6d4":"#ef4444",intensity:n?.1:1})}),e.jsx(R,{children:e.jsxs(x,{position:[0,1.1,0],fontSize:.15,color:n?"#06b6d4":"#fbbf24",anchorX:"center",children:["REALITY INTEGRITY: ",l,"%"]})}),e.jsx(G,{position:[-2.5,.8,0],transform:!0,scale:.5,style:{width:"800px",maxHeight:"350px",overflow:"hidden",pointerEvents:"none"},children:e.jsxs("div",{className:"font-mono text-sm leading-relaxed",children:[u.map((t,T)=>e.jsx("p",{className:`
