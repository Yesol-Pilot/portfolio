...
import Holo3DAvatar from './Holo3DAvatar';
            ...
            <form onSubmit={handleSend} className={`p-4 border-t ${theme.border}`}>
                <div className="relative">
                    <input
                        ...
                        placeholder={isListening ? "듣고 있습니다..." : "이 생태계에 대해 물어보세요..."}
                        className={`w-full bg-black/50 border border-white/10 rounded px-4 py-3 pr-20
                    ...
                    <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                        <button
                            ...
                            className={`p-1.5 rounded-full hover:bg-white/10 transition-colors ${isListening ? 'text-red-400' : 'text-white/50'}`}
                            title="음성으로 질문하기"
                        >
                            {isListening ? '●' : '🎤'}
                        </button>
