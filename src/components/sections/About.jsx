            ...
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                >
                    ...
                    >
                        ...
                        <p className="mb-6">
                            "왜 이 서비스가 필요한가?"라는 본질적인 질문에서 출발합니다.
                            화려한 기술이나 디자인보다 중요한 것은 사용자가 겪는 문제를 해결하고,
                            그들에게 실질적인 가치를 전달하는 것이라고 믿습니다.
                        </p>
                        <p className="text-gray-300">
                            이 포트폴리오는 단순한 작업물의 나열이 아닌,
                            제가 프로젝트를 대하는 태도와 문제 해결 과정을 담은 하나의 이야기입니다.
                            각각의 프로젝트가 어떤 맥락에서 시작되어 어떻게 완성되었는지, 그 여정을 함께 지켜봐 주시기 바랍니다.
                        </p>
                    </motion.div>
                </motion.div>
            </div>
